...
class NonLinearOModel(MAPModel):
    """
    "NonLinearOModel" for Non-Linear Output Model: model without linear
    output layer: the output layer is that of `network`
    """
    ...
    def __init__(self,
        ...
        super(NonLinearOModel, self).__init__(graph=graph)
